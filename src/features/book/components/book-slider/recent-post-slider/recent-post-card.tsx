...
import { UsedBookPost } from "@/features/book/types";
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center text-center py-4">
        ...
        <p className="mt-1 text-lg font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-violet-600 to-blue-600">
